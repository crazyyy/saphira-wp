	...
	public static function debug_data() {
		...
		if ( is_file( ABSPATH . '2.htaccess' ) ) {
			...
			if ( $filtered_htaccess_content ) {
				...
				$htaccess_rules_string = sprintf( __( 'Custom rules have been added to your %s file.' ), '2.htaccess' );
			} else {
				/* translators: %s: 2.htaccess */
				$htaccess_rules_string = sprintf( __( 'Your %s file contains only core WordPress features.' ), '2.htaccess' );
			}

			$info['wp-server']['fields']['htaccess_extra_rules'] = array(
				'label' => __( '2.htaccess rules' ),

...
class AIOWPSecurity_Configure_Settings {
	...
	public static function turn_off_all_security_features() {
		...
		//Refresh the 2.htaccess file based on the new settings
		$res = AIOWPSecurity_Utility_Htaccess::write_to_htaccess();
		if (!$res) {
			$aio_wp_security->debug_logger->log_debug(__METHOD__ . " - Could not write to the 2.htaccess file. Please check the file permissions.", 4);
		}
	}
